...
object PerformanceTests extends App {
  ...
  val doubleDotInjn: Boson = Boson.injector("..NonExistingKey[end].Tags", (in: Tags) => in)
  performanceAnalysis(doubleDotInjn, "..NonExistingKey[end].Tags")
  performanceAnalysis(doubleDotInjn, "..NonExistingKey[end].Tags", codecJson = true)
  ...
  val doubleDotInjn1: Boson = Boson.injector("..NonExistingKey", (in: String) => in)
  performanceAnalysis(doubleDotInjn1, "..NonExistingKey")
  performanceAnalysis(doubleDotInjn1, "..NonExistingKey", codecJson = true)
