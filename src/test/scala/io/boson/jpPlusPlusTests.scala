...
//  test("Ex ..key.[@elem].key") {  //TODO:possible solution is include on keylist a position representing the root
...
//  test("Ex ..key.[#]") {  //TODO:possible solution is include on keylist a position representing the root
