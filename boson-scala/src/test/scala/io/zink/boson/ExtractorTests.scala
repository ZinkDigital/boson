...
class ExtractorTests extends FunSuite {
  ...
  test("Extract BsonObject") {
    ...
    val bosonBson: BosonImpl = new BosonImpl(byteArray = Option(bsonEvent.encode().getBytes()))
    val result = bosonBson.extract(bosonBson.getByteBuf, List(("Second","allDots")), List((None,None,""))).asInstanceOf[Seq[Array[Any]]]
  ...
  test("Extract BsonArray") {
    val bosonBson: BosonImpl = new BosonImpl(byteArray = Option(globalObj.encode().getBytes()))
    val result = bosonBson.extract(bosonBson.getByteBuf, List(("Colleagues","allDots")), List((None,None,""))).asInstanceOf[Seq[Array[Any]]]
  ...
  test("Extract deep layer") {
    ...
    val bosonBson: BosonImpl = new BosonImpl(byteArray = Option(bsonEvent.encode().getBytes()))
    val result = bosonBson.extract(bosonBson.getByteBuf, List(("JoséMonthLeave","allDots")), List((None,None,""))).asInstanceOf[Seq[Array[Any]]]
